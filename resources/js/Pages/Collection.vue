            ...
            <div class="relative pt-1">
                ...
                <div class="pt-4">
                    ...
                    <div class="custom-slider">
                        ...
                        />
                        <div class="flex">
                            <input v-model="vMin" type="number" class="w-20 input" />
...
<!--                            </select>-->
    ...
    <!--                    <div v-if="!products.data.length">No product were found within the set parameters</div>-->
                        <div class="mr-6 font-ropa text-base text-left text-gray-500 border-solid">
                            ...
                            <div class="bg-gray-200 text-center text-transform: uppercase text-sm h-8  bg-green-400 bg-[#97C19B] font-ropa text-white py-0.5">Eco Friendly</div>
                            <div class="text-black bg-gray-200 text-center font-ibm text-sm mb-3 h-8 py-1">Code:WRUP4RC001ORG_Z64</div>
                            <h1>{{ product.name }}</h1>
