<template>
    ...
    <div class="text-center mt-16">
        <h1 class="font-bold font-ropa text-tra text-base text-3xl text-transform: uppercase">{{ collection.name }}</h1>
    ...
    <div class="flex justify-center mx-64">
        ...
        <div class="w-1/6 mr-6 mt-12">
            <div class="flex">
                ...
                <Link class="flex my-auto text-sm py-1 px-2" v-bind:href="'/collection/' + collection.id" preserve-scroll>
                ...
                <div class="pt-4">
                    ...
                    <div class="custom-slider">
                        ...
                        <div class="flex">
                            ...
                            <div>
                                <button @click="vMin += parseInt(1) "><svg class="fill-black" width="12" height="12" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="black" fill-rule="evenodd" clip-rule="evenodd"><path d="M23.245 20l-11.245-14.374-11.219 14.374-.781-.619 12-15.381 12 15.391-.755.609z"/>
                                </svg></button>
                            </div>
                            <div>
                                <button @click="vMin -= parseInt(1) "><svg class="fill-black" width="12" height="12" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="black" fill-rule="evenodd" clip-rule="evenodd"><path d="M23.245 4l-11.245 14.374-11.219-14.374-.781.619 12 15.381 12-15.391-.755-.609z"/>
                                </svg></button>
                            </div>
                        </div>
                            ...
                            <div class="my-auto mx-1">
                            <div>
                                <button @click="vMax += parseInt(1) "><svg class="fill-black" width="12" height="12" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="black" fill-rule="evenodd" clip-rule="evenodd"><path d="M23.245 20l-11.245-14.374-11.219 14.374-.781-.619 12-15.381 12 15.391-.755.609z"/>
                                </svg></button>
                            </div>
                            <div>
                                <button @click="vMax -= parseInt(1) "><svg class="fill-black" width="12" height="12" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="black" fill-rule="evenodd" clip-rule="evenodd"><path d="M23.245 4l-11.245 14.374-11.219-14.374-.781.619 12 15.381 12-15.391-.755-.609z"/>
                                </svg></button>
                            </div>
                        </div>
                        </div>
...
<!--                            </select>-->
                 ...
                 <div class="flex flex-wrap" v-if="$page.props.selectedView === 'multi'">
                    <div class="w-1/4" v-for="product in products.data">
    <!--                    <div v-if="!products.data.length">No product were found within the set parameters</div>-->
                        <div class="mr-6 font-ropa text-base text-left text-gray-500 border-solid">
                            ...
                            <div class="text-black bg-gray-200 text-center font-ropa text-xs mb-3 h-4">Code:WRUP4RC001ORG_Z64</div>
                            <h1>{{ product.name }}</h1>
...
let blue = ref(props.filters.blue);
let beige = ref(props.filters.beige);
let grey = ref(props.filters.grey);
let military = ref(props.filters.military);
let pink = ref(props.filters.pink);
let black = ref(props.filters.black);
let length34 = ref(props.filters.length34);
let length78 = ref(props.filters.length78);
let lengthBl = ref(props.filters.lengthBl);
let lengthS = ref(props.filters.lengthS);
let lengthN = ref(props.filters.lengthN);
let sizeXxs = ref(props.filters.sizeXxs);
let sizeXs = ref(props.filters.sizeXs);
let sizeS = ref(props.filters.sizeS);
let sizeM = ref(props.filters.sizeM);
let sizeL = ref(props.filters.sizeL);
let sizeXl = ref(props.filters.sizeXl);
