            ...
            <div class="relative pt-1">
                ...
                <div class="pt-4">
                    ...
                    <div class="custom-slider">
                        ...
                        />
                        <div class="flex">
                            <input v-model="vMin" type="number" class="w-20 input [-webkit-appearance:_textfield] [&::-webkit-outer-spin-button]:bg-black [bg:textfield] [&::-webkit-inner-spin-button]:bg-black" />
