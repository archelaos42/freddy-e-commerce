<template>
    <AppLayout>
        <div class="bg-gray-200 py-5">
            <!--            <h1 class=" text-center text-4xl mt-16 mb-12">Your review has been successfully submitted!</h1>-->
            <h1 class="text-center text-2xl mb-12">Your have successfully singed up for our mailing list.</h1>
            <p class="text-center text-xl">Thank you for your trust!</p>
            <div class="flex flex-col items-center mt-12">
                <button class="px-4 flex font-ropa text-white text-transform: uppercase bg-black pr-1 pl-2 mr-3">
